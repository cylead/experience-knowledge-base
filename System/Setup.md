...
6. Open [[Home]] and pin it if you want it to remain your starting dashboard.

The dashboard embeds views from [[Knowledge.base]]. The table layout requires Obsidian 1.9 or later. No community plugin is required.
